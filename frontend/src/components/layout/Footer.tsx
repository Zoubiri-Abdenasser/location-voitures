export default function Footer() {
  return (
    <footer className="border-t border-border mt-24 bg-surface-alt">
      <div className="lane-divider" />
      <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 md:grid-cols-3 text-sm text-muted">
        <div>
          <p className="font-display font-bold text-ink mb-2">زوبيري</p>
          <p>اكرِ سيارتك بسهولة وأمان، في أي وقت وأي مكان.</p>
        </div>
        <div>
          <p className="font-display font-bold text-ink mb-2">روابط سريعة</p>
        ...
        <div>
          <p className="font-display font-bold text-ink mb-2">تواصل معنا</p>
